          ...
          <table className="w-full text-left text-xs">
            <thead className="text-charcoal uppercase tracking-wider text-[11px] font-black border-b-2 border-charcoal bg-cream">
              <tr>
                ...
                <th className="py-2.5 px-3">{language === 'hi' ? 'आपूर्तिकर्ता' : 'Supplier'}</th>
              ...
              {MOCK_ORDERS_FULL.map((ord) => (
                <tr key={ord.id} className="hover:bg-cream/60 transition-colors">
                  ...
                  <td className="py-2.5 px-3 font-sans font-bold text-charcoal">
                    {language === 'hi' ? ord.farmerHi : ord.farmer}
                  </td>
                  <td className="py-2.5 px-3 font-sans font-bold text-charcoal">
                  ...
                  <td className="py-2.5 px-3 font-sans">
                    <span
                      style={{
                        backgroundColor: ord.status === 'inTransit' || ord.status === 'pickupScheduled' ? '#EAB308' : '#4D7C0F',
                        color: ord.status === 'inTransit' || ord.status === 'pickupScheduled' ? '#172016' : '#FFFFFF',
                      }}
                      className="px-2 py-0.5 text-[10px] font-black uppercase border border-charcoal shadow-bauhaus-sm"
                    >
                      {language === 'hi' ? ord.statusLabelHi : ord.statusLabel}
                    </span>
                  </td>
                </tr>
              ))}
