...
export const ProcurementRequest = () => {
  ...
  const handleFillDemoData = () => {
    ...
    addToast(
      language === 'hi'
        ? 'डेमो खरीद डेटा भरा गया (500 किग्रा टमाटर, ग्रेड A, ₹30/किग्रा)'
        : 'Demo procurement filled (500 kg Tomato, Grade A, ₹30/kg ceiling)',
      'info'
    );
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate('/buyer/marketplace', {
        state: { demand: formData, sourcingMode: 'smart' },
      });
    } catch (err) {
